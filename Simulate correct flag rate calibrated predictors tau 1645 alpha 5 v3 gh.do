...
local run_nme="Correct flagging rates for calibrated predictors tau `tau1000' alpha `alpha' v3"
...
gen z=rnormal(0,1)
*Only interested in correct flagging rates, so only keep those >\tau
keep if z>`tau'
